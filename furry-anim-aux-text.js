...
/**
 * Use this file to put lenthier, arbitrary text using string literals. You 
 * would then use these constants to, for example, add text to the splash screen
...
const text_popup_menu_other_sites = `
	...
	<p>
		...
		Has animations like this one, and raw blender files 
		available for download. No login required.
	</p>
`;
...
const text_popup_menu_license_html = `
	<p>
		<b>Copyright and Licenses:</b>
	</p>
	<p>
		This interactive animation, as composited and 
		fixed in its final form, is Copyright YYYY 
		by THE ARTIST. All rights, not elsewhere limited, are reserved.
	</p>
	<p>
		<b>Sound effects:</b>
	</p>
	<p>
		<ul>
			<li>
				...
				The sound effect was modified by Zennith's player to make it 
				suitable for looping without being noticable by the listener. 
			</li>
		</ul>
	</p>
	<p>
		<b>This video playing software:</b>
	</p>
	<p>
		<ul>
			<li>
...
const content_warning = `
	<p>
		The following EXAMPLE content is SAFE TO VIEW BY ALL AUDIENCES.
	</p>
	<p>
		Do not view it if... you don't feel like it I guess? :P
	</p>
`;
...
const cascade_intro_text_A = `
	<p>
		A cube spins...and spins and spins...
	</p>
`;
...
const cascade_intro_text_C = `
	<p>
		Bounce? Jolt? Hustle? Jiggle? Undulate? 
		Make hypnotic motions of some sort? 
	</p>
`;

const cascade_intro_text_D = `
	<p>
		Nope! Going to keep spinning.~ 
	</p>
	<p>
		Note that this video currently has a blurry black framing, that you can use 
		to mimic a Point-Of-View effect for the user. Simply edit the HTML file 
		to use a different image or disable it. Easy! 
	</p>
`;
